...
**closeness**, and **PageRank** centralities, using an igraph object as
input. For weighted networks, users can specify the `weight` parameter
to indicate the edge attribute representing the desired weighting
scheme.
