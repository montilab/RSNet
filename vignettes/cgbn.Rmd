...
v-structure is inferred when two variables $X$ and $Y$ are marginally independent but become conditionally dependent upon conditioning on a third variable $Z$, as illustrated in the following figure:
