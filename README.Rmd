...
[![GitHub issues](https://img.shields.io/github/issues/montilab/RSNet)](https://github.com/montilab/RSNet/issues)
[![GitHub last commit](https://img.shields.io/github/last-commit/montilab/RSNet)](https://github.com/montilab/RSNet)
...
For Gaussian networks, **RSNet** further provides cluster-based sampling options specifically designed to accommodate correlated or family-based data, including:
  ...
  1. Cluster-based bootstrap, which resamples entire clusters with replacement to preserve intra-cluster dependence. 
  2. Fractional cluster-based bootstrap, which resamples only a subset of clusters with replacement, offering improved computational efficiency while retaining cluster-level correlation structure.
