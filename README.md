...
The Conditional Gaussian Bayesian Network (CGBN) functionalities
`ensemble_cgbn` and `consensus_net_cgbn` are optional and require the
`RHugin` package. Installation instructions for
